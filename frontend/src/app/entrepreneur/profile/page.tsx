        ...
        {isEditing && (
          <div className="flex flex-col items-center gap-2">
            <label
              ...
              className="px-6 py-2 bg-black text-white rounded-full cursor-pointer hover:bg-gray-800 transition-colors shadow-md"
            >
              {isUploading ? (
                      ...
                      {profile.skills.map((skill, index) => (
                        <div
                          ...
                          className="inline-flex items-center gap-2 px-3 py-1 
                            bg-gray-200 text-gray-800 rounded-full hover:bg-gray-300 transition-colors"
                        >
              ...
              {isEditing && (
                <div className="flex justify-end space-x-4">
                  <Button
                    ...
                    className="bg-gray-200 text-gray-700 hover:bg-gray-300 rounded-md px-6 py-3"
                  >
                    Cancel
                  </Button>
                  <Button
                    type="submit"
                    className="bg-gray-900 hover:bg-gray-800 text-white rounded-md px-6 py-3"
                  >
                    Save Changes
                  </Button>
                </div>
