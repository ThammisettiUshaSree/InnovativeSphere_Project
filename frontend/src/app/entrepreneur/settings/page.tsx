 ...
 * Allows users to manage account settings including password and account deletion
 */
const SettingsPage = () => {
  ...
  const handleDeleteAccount = async () => {
    ...
    try {
      ...
      const response = await fetch(API_ROUTES.AUTH.DELETE_ACCOUNT, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
            ...
            <Card className="bg-white shadow-md border border-gray-200">
              ...
              <CardContent className="p-6">
                <Alert variant="destructive">
                  ...
                  <AlertDescription>
                    Deleting your account will permanently remove all your data, including startups, investment opportunities, and connections. This action cannot be undone.
                  </AlertDescription>
</Alert>
