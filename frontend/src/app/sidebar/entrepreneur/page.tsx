...
export default function EntrepreneurSidebarPage() {
  const [isMobileOpen, setIsMobileOpen] = useState(false);
  const [isCollapsed, setIsCollapsed] = useLocalStorage(
    "entrepreneur-sidebar-collapsed",
    false
  );
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
        <div className="h-16 border-b flex items-center justify-between px-4">
          <Link href="/entrepreneur/home" className="flex items-center gap-3">
      ...
      {/* PAGE CONTENT (STATIC – REQUIRED FOR page.tsx) */}
      <main
      ...
      >
        ...
        <p className="mt-2 text-gray-600">
          Use the sidebar to navigate through your account.
        </p>
      </main>
    </div>
  );
